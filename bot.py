...
from handlers.utils      import require_unlock             # noqa: F401  (used by other handlers)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.callback_query:               # navigating back from a submenu
...
def main():
    ...
    register_stockin_handlers(app)          # ← NEW module enabled
