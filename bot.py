...
from handlers.reconcile  import register_reconcile_handlers, show_reconcile_menu
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    kb = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("Stock-In",       callback_data="stockin_menu"),
         InlineKeyboardButton("Reconciliation", callback_data="reconcile_menu")],
    ])
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(show_reconcile_menu, pattern="^reconcile_menu$"))
    register_reconcile_handlers(app)
