...
# Feature-module registrations / menus
...
from handlers.reports.owner_report import register_owner_report_handlers  # <─ only this
...
# ════════════════════════════════════════════════════════════
# Main Menu and Nested Sub-menus
# ════════════════════════════════════════════════════════════
...
async def show_addfinancial_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    kb = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("Expenses", callback_data="expense_menu")],   # ← fixed
...
async def run_bot():
    ...
    # Top-level “Reports” menu buttons (customer, partner, store reports only;
    # owner summary handled inside owner_report registration)
